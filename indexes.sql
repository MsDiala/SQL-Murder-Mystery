...
-- Fix drivers_license joins (Q2, Q8):
CREATE INDEX idx_drivers_license_id 
ON drivers_license(id);

-- Fix income join (Q8 bottleneck)
CREATE INDEX idx_drivers_license_id 
ON drivers_license(id);


-- Optional:
--Partial index for Q4 (VERY smart)
CREATE INDEX idx_member_gold_only 
